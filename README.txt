...
Note that this is still a Work in Progress (WiP), so contact me if you have any questions.
 ...
 Introduction:
---------------
Follow these steps to install this mobile friendly app template on a LAMP (Linux Apache MySql PHP) server.
...
Update the JavaScript object literals in these files so that they contain the content of your phoneMenu app.

To verify that you have everything set up properly, access the following file in your web browser:
